...
export default function Pricing() {
  const openCalendly = () => {
    window.open('https://calendly.com/medhansh_k/mk-101', '_blank');
  };
    ...
    <section className="px-4 md:px-6 py-16 md:py-24 bg-[#070B14]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-6">Choose Your Plan</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-400 mb-6 text-sm md:text-base">Perfect for small businesses and startups.</p>
              <button className="w-full py-3 px-4 bg-[#00FFD1]/10 text-[#00FFD1] rounded-lg border border-[#00FFD1]/20 hover:bg-[#00FFD1]/20 transition-colors text-sm md:text-base">
                Get Started
              </button>
            </div>
            <div className="border-t border-gray-800 p-6">
              <ul className="space-y-3">
                ...
                <Feature available>Single Agent</Feature>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-lg md:text-xl font-semibold mb-4">Need Help Choosing?</h3>
          ...
          <button 
            onClick={openCalendly}
            className="px-6 md:px-8 py-2 md:py-3 bg-[#00FFD1] rounded-full text-black font-medium text-sm md:text-base hover:bg-[#00FFD1]/90 hover:shadow-[0_0_20px_rgba(0,255,209,0.4)]"
          >
            Talk to Sales
          </button>
        </div>
