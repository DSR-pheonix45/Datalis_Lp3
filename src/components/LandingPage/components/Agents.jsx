  ...
  return (
    <AnimatedBlock delay={0.1}>
      <div>
        ...
        <motion.div 
          className="bg-[#070B14] p-4 sm:p-6 md:p-8 rounded-xl border border-gray-800 overflow-hidden relative transition-all duration-300"
          whileHover={{ 
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 relative z-10">
            ...
            <div className="w-full md:w-1/3 mb-6 md:mb-0 order-1 md:order-2">
              <img 
                src={image1} 
                alt="Consultant Agent" 
                className="w-full max-w-[200px] md:max-w-none mx-auto md:mx-0 h-auto rounded-lg relative z-10 shadow-lg border border-[#00FFD1]/20" 
              />
            </div>
          </div>
        </motion.div>
